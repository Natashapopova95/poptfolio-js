      ...
      <section class="portfolio" id="portfolio">
        ...
        <div class="container">
          <div class="portfolio__wrapper">
            <a
              href="https://shop-chi-one.vercel.app/"
              class="portfolio__container"
            >
              <img
                src="/images/2023-07-27_17-00-45.png"
                alt=""
            ...
            <a href="http://yanaeva68.ru" class="portfolio__container">
              <img
                src="/images/2023-07-27_17-01-29.png"
                alt=""
                class="portfolio__img"
              />
      ...
      <section class="feedback" id="feedback">
        ...
        <div class="container">
          <div class="feedback__wrapper">
            ...
            <form action="check_post.php" method="post" id="forms" class="form">
              ...
              <input type="submit" class="link" type="submit" value="Отправить заявку"></input>
            </form>
